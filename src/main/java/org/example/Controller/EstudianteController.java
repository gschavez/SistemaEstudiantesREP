...
import org.example.Service.IGestionEstudiantes;
...
public class EstudianteController {
    ...
    public void iniciar() {
        ...
        IGestionEstudiantes sistema = new SistemaGestionEstudiantes();
...

        {
            while (continuar) {   //Menu basico con las acciones que tendra el programa
                ...
                switch (opcion) {//se poblan los datos del objeto
                    ...
                    case 2 -> {
                        List<Estudiante> lista = sistema.listarEstudiantes();
                        if (lista.isEmpty()) {
